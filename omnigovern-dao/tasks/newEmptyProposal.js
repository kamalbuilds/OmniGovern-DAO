...
module.exports = async function (taskArgs, hre) {
    ...
    console.log(`✅ [${hre.network.name}] OmniGovernDAO.crossChainPropose([${incrementer.address}], [0], [${incrementData}], ${taskArgs.desc})`)
    ...
    console.log(`[${hre.network.name}] OmniGovernDAO.crossChainPropose => proposeId: ${proposalCreatedEventDecoded[0].toString()}`)
