...
const CampaignDetails = () => {
  ...
  const typedState = {
    ...data,
    target: data?.target ? ethers.utils.formatEther(data?.target.toString()) : '0',
    amountCollected: data?.amountCollected ? ethers.utils.formatEther(data?.amountCollected.toString()) : '0',
